...
const Spendings = () => {
  ...
  const spendingCategories = {
    labels: ['Food', 'Transport', 'Rent', 'Entertainment', 'Misc'],
    datasets: [
      {
   ...
   <>    
   {
    ...
    <AsideDashboard/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 shadow-md rounded-lg p-4">
          <h2 className="text-xl font-semibold">Total Pendings This Week</h2>
          <p className="text-2xl font-bold text-red-600">$1,200</p>
        </div>
        <div className="bg-gray-800 shadow-md rounded-lg p-4">
          <h2 className="text-xl font-semibold">Total Spendings This Year</h2>
          <p className="text-2xl font-bold text-red-600">$52,000</p>
        </div>
      </div> 
